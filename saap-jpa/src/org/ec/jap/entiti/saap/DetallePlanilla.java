...
@NamedQueries({
		...
		@NamedQuery(name = "DetallePlanilla.findByInc", query = "SELECT d FROM DetallePlanilla d where d.idCabeceraPlanilla!=:idCabeceraPlanilla AND d.idCabeceraPlanilla.idServicio=:idServicio AND d.estado IN ('NOPAG','INC') ORDER BY d.ordenStr,d.fechaRegistro ASC"),
